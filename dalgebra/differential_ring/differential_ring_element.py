r"""
File for the element structure of Differential rings

This file contains all the element structures for Differential rings.

AUTHORS:

    - Antonio Jimenez-Pastor (2021-07-08): initial version
...
class DiffRingElement (InfinitePolynomialGen):
    r'''
