...
class LSeries_Element(Element):
    r'''
        ...
        3. TODO (laurent): By providing a differential polynomial in one variable with coefficients in the constant field. This is interpret as a differential algebraic equation that the formal laurent series must satisfy. We require for this input a set of initial conditions that determines the formal power series uniquely. This is the most complex way to create a formal power series, but it allow for zero testing while keeping the tail infinite.
    '''
