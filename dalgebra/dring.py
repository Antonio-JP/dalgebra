        ...
        def laurent_morphism(self, imgs: dict[str|Element, Element] = None, constant: Parent = None, set_default: bool = False) -> MorphismToLaurent:
            r'''
                ...
                * If ``set_default`` is ``True``, the computed morphism is stored as default,
                ...
                TODO (laurent): check the behavior of this method in general
            '''
            if imgs is None:
...
class DRing_Wrapper(Parent):
    ...
    def _laurent_morphism(self, imgs, constant=None, _: bool = False) -> MorphismToLaurent:
        r'''
            ...
            TODO (laurent): check the correct implementation of Laurent morphisms for wrapped rings.

            ::NO EXAMPLE::
        '''
        ## TODO (laurent): Check this implementation when the wrapped ring is a quotient ring.
...
####################################################################################################
###
### MORPHISMS TO LAURENT SERIES RINGS
###
####################################################################################################
