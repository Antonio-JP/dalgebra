...
project = u"Differential Algebra in Sage"
copyright = u'2021'
...
if (os.environ.get('SAGE_DOC_MATHJAX', 'no') != 'no'
    ...
    #mathjax_path = 'MathJax.js?config=TeX-AMS-MML_HTMLorMML-full,../MathJax.js'
    ...
    #sagenb_path = working_set.find(Requirement.parse('notebook')).location
    #mathjax_relative = os.path.join('notebook','static','components','MathJax')
