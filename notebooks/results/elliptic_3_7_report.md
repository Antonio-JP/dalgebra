...
* Checking case 0: (Solution Branch [a_3=-6,a_2=-12,g_2=0] and g_3 as free variables.) include any solution for a lower level
  - Checking the cases for level 1:
    [False] - Solution Branch [a_3=0,a_2=0] and g_2,g_3 as free variables.
  ...
  - Checking the cases for level 4:
    ...
    [False] - Solution Branch [a_3=0,a_2=-3/2] and g_2,g_3 as free variables.
  - Checking the cases for level 5:
    ...
    [False] - Solution Branch [a_3=0,a_2=-3] and g_2,g_3 as free variables.
...
### Starting case 1/4:
* Branch: Solution Branch [a_3=0,a_2=-15/2,g_2=0] and g_3 as free variables.
* Operator: -(15/2*eta)*z_1 + z_3
* Flag: [55/12*g_3, 0, 0, 0, 1]
* Centralizer:
  - (0 -- 0) z_0
  - (1 -- 7) (175/4*eta^3 + 25*g_3)*z_1 + (175/2*eta*eta_p)*z_2 + (35/2*eta^2)*z_3 - (35*eta_p)*z_4 - (35/2*eta)*z_5 + z_7
  - (2 -- 11) (13475/4*eta^5 + 2750*g_3*eta^2)*z_1 + ((13475/2*eta^3 + 1650*g_3)*eta_p)*z_2 + (13475/2*eta^4 + 9075/2*g_3*eta)*z_3 + (4125*eta^2*eta_p)*z_4 + (3025/2*eta^3 + 385*g_3)*z_5 + (165*eta*eta_p)*z_6 - (165*eta^2)*z_7 - (110*eta_p)*z_8 - (55/2*eta)*z_9 + z_11
### Starting case 2/4:
