...
### Starting case 0/2:
* Branch: Solution Branch [a_3=0,a_2=-3/2] and g_2,g_3 as free variables.
* Operator: -(3/2*eta)*z_1 + z_3
* Flag: [0, 0, 1]
* Centralizer:
  - (0 -- 0) z_0
  - (1 -- 4) -(1/6*g_2)*z_0 - eta_p*z_1 - (2*eta)*z_2 + z_4
  - (2 -- 5) -(5/4*eta^2 + 3/4*g_2)*z_1 - (5/2*eta_p)*z_2 - (5/2*eta)*z_3 + z_5
### Starting case 1/2:
