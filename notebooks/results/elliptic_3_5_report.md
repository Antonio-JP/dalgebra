...
### Starting case 0/2:
* Branch: Solution Branch [a_3=0,a_2=-3] and g_2,g_3 as free variables.
* Operator: -(3*eta)*z_1 + z_3
* Flag: [-1/3*g_2, 0, 0, 1]
* Centralizer:
  - (0 -- 0) z_0
  - (1 -- 7) -(3*g_3)*z_1 - (7*eta*eta_p)*z_2 - (14*eta^2 + 28/3*g_2)*z_3 - (14*eta_p)*z_4 - (7*eta)*z_5 + z_7
  - (2 -- 5) -(2*g_2)*z_1 - (5*eta_p)*z_2 - (5*eta)*z_3 + z_5
### Starting case 1/2:
